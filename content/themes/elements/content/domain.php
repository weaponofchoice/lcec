...
$domain_c_image = get_sub_field( 'domain_c_background' );
...
<section class="section_domain">
  ...
  <div class="top" style="background:url('<?php echo $domain_c_image['sizes']['large']; ?>')">
    
  </div>
  
  <div class="bottom" style="background:url('<?php echo $domain_c_image['sizes']['large']; ?>')">
